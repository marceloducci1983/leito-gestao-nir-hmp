...
const AppContent: React.FC = () => {
  ...
  return <Router>
      <div className="min-h-screen bg-background">
        ...
        {showPasswordChanger && <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-40">
            <div className="bg-white p-6 rounded-lg">
              <AdminPasswordChanger />
              <button onClick={() => setShowPasswordChanger(false)} className="mt-4 w-full bg-gray-200 text-gray-800 px-4 py-2 rounded">
                Fechar
              </button>
            </div>
          </div>}
